...
export const products: Product[] = [
  ...
  {
    slug: "t-shirt-oversize-hanami",
    name: "T-shirt Oversize Hanami",
    category: "t-shirts",
    price: 27.9,
    emoji: "👕",
    badge: "Nouveau",
    short: "Coupe oversize confortable, imprimé pastel Hanami.",
    description:
  ...
  {
    slug: "sabots-edition-hanami",
    name: "Sabots Édition Hanami",
    category: "crocs",
    price: 36.9,
    emoji: "🩴",
    badge: "Nouveau",
